...
//tessellator variables
$string['vpl']='Labs';
$string['assign']='Assignments';
$string['quiz']='Quiz';
$string['forum']='Forum';
$string['teleconnect']='teleconnect';
...
$string['cookiesenabled'] = 'Prior to proceeding, we recommend that you carefully review the instructions below.';
...
$string['cookiesenabled_help_html'] = '1.Kindly take your designated seat at the system number mentioned in your exam slip.</br>
2.Please log in using the credentials provided in your exam slip.</br>
3.After logging in, we kindly request that you should NOT close the browser window.</br>
4.If you close the browser, you will not be able to login again with same password.</br>
5.Kindly avoid switching off the system during the exam.</br>
6.In case of any issues with the system, please inform the invigilator immediately.';
...
$string['cookiesnotice'] = 'instructions';
$string['copy'] = 'copy';
...
// $string['poweredbymoodle'] = 'Powered by <a href="https://moodle.com">Moodle</a>'; // commented moodle link in footer
$string['poweredbymoodle'] = 'Powered by Teleparadigm Networks'; //added teleparadigm to footer
