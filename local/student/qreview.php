...
$PAGE->requires->css('/local/student/styles/custom1.css');
    ...
    $PAGE->requires->css('/teacher/reports/teacher.css');
}


$PAGE->set_url('/local/student/qreview.php');
...
// if ($('#roles').val()) {
    ...
    //document.getElementById('page-navbar').innerHTML = "<div id='navbar' style='padding: 2% 6% 1% 2%; display: flex; align-items: center;'>  <span style='margin: 0 5px;'></span> Review </div>";
