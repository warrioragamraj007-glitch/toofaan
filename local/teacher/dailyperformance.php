...
<!-- <label for="from">From:</label>
    ...
    <div class="abs-summary row">
        ...
        <div class="col-md-2">
            <!-- <center><h3>Daily Performance Report</h3></center> -->
            <a id="getresults" class="switch-button" style="">Get Results</a>

        </div>
        <div class="col-md-2">
            <!-- <a id="getresults" class="switch-button">Get Results</a> -->
            <a target="_blank" href="http://teleuniv.in/trinetra/pages/templates/wrapper/uploadcpcperformance/upload-cpc-performance.php" class="switch-button" style="background-color: #3c8dbc;" id="yui_3_17_2_2_1716460692695_24">Upload To Sanjaya</a>
        </div>
        
    </div>
</div>
                <div class="daily-wise-hits" >
                                <center><i><b style="color:red;">Note:Grades will be automatically uploaded by the end of the day. No manual action is required.</b></i></center>
                    <div class="col-md-12"><span class="download2" id="sxls">XLSX</span>
...
console.log('XLSX.utils.table_to_sheet:', XLSX?.utils?.table_to_sheet);
                ...
                $j("#sxls").click(function(){
                    ...
                    if(parseInt($("#subjects-dropdown").val())){
                        ...
                        //         exclude: ".noExl",
                        //         name: "Table2Excel",
                        //         filename: subject+'-PERF-'+"-REPORT-" +date ,//do not include extension
                        //         // fileext: ".xlsx"
                        //     });
                        // }
                        if (rowCount > 2) {
            ...
            // Generate a filename
            var filename = subject + '-PERF-' + "-REPORT-" + date + '.xlsx';
...
if(parseInt($("#subjects-dropdown").val())){
    ...
    //     });
    // }).trigger('sorton', [[[1, 0]]]); // Optional: Initial sort by Roll No
            });
        }
    });
}
