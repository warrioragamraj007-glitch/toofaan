    ...
    if($display_flag){
		...
		$starCount++;
            ...
            echo '<tr>
				...
				<td><a target="_blank" href="'.$CFG->wwwroot.'/report/outline/user.php?id='. $userinfo->id.'&course='.$course->id.'&mode=outline'.'">' . $rollno . '</a></td>
                ...
                <td style="text-align:center">' . $slang . '</td> 
