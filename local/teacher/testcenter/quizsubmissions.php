...
$id=(int)$params[0];   //courseid
$cid=$id;
//retriving course id from url

if(!$cid){
$cid = required_param('cid', PARAM_INT);
$qid = required_param('id', PARAM_INT);     //quizid or activityid
}
...
<td style="text-align:center"><span style="display:none">-1</span><span>NA</span></td>
				...
				<td><img data-ref="' . $watchliststatus . '" id="' . $student->id . '" class="watchlist" src=" ' . $CFG->wwwroot . '/local/teacher/testcenter/images/' . $watchlist_icon . '" width="  16px"/></td>
