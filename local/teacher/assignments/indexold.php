...
<div class="container container-demo" style="">
    ...
    ?>
     <div class="upload-performance" style="margin-left:85%;margin-top:2%;margin-bottom:-2%;" >
        ...
        <div class="tab-pane " id="b" >
                ...
                <div style="padding-bottom:64px;" class="status-counts-div" id="container">
                    ...
                    <div class="showactivity">
                        ...
                        <span class="curassign"><?php echo $assignname ?> </span>
                    </div>
                    ...
                    <div class="status-div">
                        ...
                        <div class="excel" style="float: right;">
                            <i class="fa fa-1x fa-download" style="margin-top:-32%;     margin-left: 50%;   font-size: 125%;margin-right: -45%;" aria-hidden="true" id="sxls">XLS</i>
                                    </div>
                        <!-- <div class="excel">
...
<script>
    ...
    //             if (rowCount > 0) {
    //                 $j("#myTable span[style*='display:none']").remove();
    //                 $j("#myTable").table2excel({
    //                     exclude: ".noExl",
    //                     name: "Table2Excel",
    //                     filename: 'Assign-REPORT-' + new Date().toISOString().split('T')[0], // Filename with date
...
if (rowCount > 0) {
 ...
 $clonedTable.find('span[style*="display:none"]').remove();
    ...
    $tempDiv.find("#myTable").table2excel({
        exclude: ".noExl",
        name: "Table2Excel",
        filename:  coursename+'-'+assignname+'-' + new Date().toISOString().split('T')[0], // Filename with date
        fileext: ".xls" // File extension
    });
