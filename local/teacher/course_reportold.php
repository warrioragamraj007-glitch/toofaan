...
$j("#txls").click(function(){
                // $j("#teleattTable").table2excel({
                    ...
                    // exclude: ".noExl",
                    // name: "Table2Excel",
                    // filename: subjectname+" Overall Report" //do not include extension
// xlsx format
var table = document.getElementById("teleattTable");
    ...
    var filename = subjectname + " Overall Report.xlsx";
    ...
    <div class="col-md-3" style='margin-bottom:05px'>
        <a id="teleconnect-search" class="search-button">SEARCH</a>
                    ...
                    <div class="col-md-12 ">
                        ...
                        <span class="download2" id="txls">XLSX
                        </span>
                        </div>
                    </div>
                        ...
                        <div style="padding-bottom:30px;" class="table-responsive" id="container">
                            <table class="CSSTableGenerator table table-hover course-list-table tablesorter" id="teleattTable">
                                ...
                                <tr>
                                    ...
                                    <th class="header">Hall TicketNo</th>
                                    <th class="header">Student Name</th>
<th class="header">Total Score</th>
                                    <th class="header">Total Activites</th>
