...
$PAGE->set_url('/report/outline/studentreport.php', array('id'=>$user->id, 'course'=>$course->id, 'mode'=>$mode));
...
$navigationnode = array(
        'url' => new moodle_url('/report/outline/studentreport.php', array('id' => $user->id, 'course' => $course->id, 'mode' => $mode))
    );
if ($mode === 'complete') {
...
foreach ($sections as $i => $section) {
         // Skip the first section //general section that contains announcements forum
    if ($skipFirstSection) {
