...
function report_outline_print_row($mod, $instance, $result) {
    ...
    // echo "   href=\"$CFG->wwwroot/mod/$mod->modname/view.php?id=$mod->id\">".format_string($instance->name,true)."</a></td>"; //commented to remove links for activities in reports
    //******** added this line to show only static text of activity name */
