...
$PAGE->set_url('/supervisor/attendanceinfo.php');
...
$PAGE->set_title('Tessellator 4.0 - Supervisor Attandance Info');
echo $OUTPUT->header();
...
<div class='container'>
    <h2 class="studentsinfo-header">Attandance Info</h2>
...
<script>
    ...
    $j(document).delegate("#search","click",function(){
        ...
        if(parseInt($j("#cateogry-dropdown").val())==0){
            ...
            if(parseInt($j("#subjects-dropdown").val())==0){
                ...
                getStudents($j("#subjects-dropdown").val(),$j("#cateogry-dropdown").val(),attandance,sdate,student,avgattandance);
            }
    ...
    function getStudents(cid,catid,attandance,sdate,student,avgattandance){
