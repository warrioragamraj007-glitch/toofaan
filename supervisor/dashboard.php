...
<div id="navbar" class="col-md-12">
    <a id='dlink' href='<?php echo $CFG->portal.'registration/login.php'?>'>Dashboard</a> <span>/</span> <b>Supervisor Dashboard</b>
</div>
<div class='container'>
...
<!--<li id='talink' ><a href="<?php //echo $CFG->wwwroot.'/'.'supervisor/tareports/reports.php'?>" data-toggle="tab">TA Reports
							<i class="fa fa-angle-double-right" aria-hidden="true"></i>
						</a></li>-->
								...
								<div class="col-md-12 search-box">
									...
									<div class="col-md-12">
										...
										<div class="col-md-3" style='margin-top:15px;text-align:center;'>
											<input id="search" type="button" name="search" class="btn" value="Search" style="padding: 5px 25%;"  placeholder="search" />
<span title='hide filters' class="hidesearch hss" style="float:right"><i  class="fa fa-arrow-up" aria-hidden="true"></i></span>
										</div>
							...
							<div class="table-responsive">
								<table class="table table-hover course-list-table tablesorter" id="myTable">
									...
									<tr>
										...
										<th title="Average Class Mean Attendance" style="">AAT(%)</th>
						...
						<div class="search-content">
							<div class="col-md-12 search-box">
								<div class="student-filters col-md-12">
									...
									<div class="col-md-4" style='margin-bottom:5px'>
										<div class="text-label">Attendance</div>
										<select id="attandance">
											<option value="0">Absent</option>
											<option value="1">Present</option>
											<option value="2">Absent & Present</option>
											<option value="3">Average Attendance</option>
										</select>
									</div>
								...
								<div class="col-md-12">
									...
									<div id="avg-attandance-div" class="col-md-4" style='display:none;margin-bottom:5px'>
										<div class="text-label">Average Attendance</div>
...
<span class="hidesearch has" title='hide filters' style="float:right"><i  class="fa fa-arrow-up" aria-hidden="true"></i></span>
									</div>
								</div>
...
<span class="hidesearch hps" title='hide filters' style="float:right"><i  class="fa fa-arrow-up" aria-hidden="true"></i></span>
									</div>
								</div>
...
location.href=$j(this).attr('href');
	...
	$j(document).delegate(".hss","click",function(){
		if(parseInt($j("#cateogry-dropdown").val())) {
			$j(".current-selection").slideDown();
			$j(".search-content").slideUp();
		}
	});
	$j(document).delegate(".has","click",function(){
		if(parseInt($j("#attandance-cateogry-dropdown").val())) {
			$j(".current-selection").slideDown();
			$j(".search-content").slideUp();
		}
	});
	$j(document).delegate(".hps","click",function(){
		if(parseInt($j("#grade-cateogry-dropdown").val())) {
			$j(".current-selection").slideDown();
			$j(".search-content").slideUp();
		}
	});
