...
// if (isguestuser() || user_has_role_assignment($USER->id, 3) || user_has_role_assignment($USER->id, 5)) {
...
?>
    ...
    <?php if(user_has_role_assignment($USER->id,5) || user_has_role_assignment($USER->id,3) ){ 
        ?>
...
.drawer-toggler > button:nth-child(1) {
display: none;
}
.eventname{
    white-space: normal;
