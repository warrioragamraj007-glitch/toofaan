...
?>
<!-- removing unnecessary links for students -->

<?php if(user_has_role_assignment($USER->id,3)) { ?>
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            // Check if the URL contains action=savegradingresult
            if (window.location.search.includes('action=savegradingresult')) {
...
<style>
    ...
    #fitem_id_sendstudentnotifications {
        display:none;
    }
#page-navbar {
    display:none;
