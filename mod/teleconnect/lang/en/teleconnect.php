...
$string['teleconnect'] = 'Tele Connect';
$string['teleconnectfieldset'] = 'Tele Connect Settings';
$string['teleconnecthost'] = 'Tele Connect Host';
$string['teleconnecthostdescription'] = 'The host can give other users privileges, start and stop a meeting in addition to what a persenter can do';
$string['teleconnectintro'] = 'Intro';
$string['teleconnectname'] = 'Meeting title';
$string['teleconnectparticipant'] = 'Tele Connect Participant';
$string['teleconnectparticipantdescription'] = 'Can view, but cannot modify any of the meeting settings';
$string['teleconnectpresenter'] = 'Tele Connect Presenter';
$string['teleconnectpresenterdescription'] = 'The presenter of a meeting and can present content, share a screen, send text messages, moderate questions, create text notes, broadcast audio and video, and push content from web links';
$string['allusers'] = 'all users';
$string['assigntelerole'] = 'Assigning Tele Roles';
$string['assignteleroles'] = 'Assigning $a->role role for $a->meetname ($a->groupname)';
...
$string['meethost_desc'] = 'Domain where the Tele server is installed';
...
$string['modulename'] = 'Tele Connect';
$string['modulenameplural'] = 'Tele Connect';
...
$string['port'] = 'Port';
$string['port_desc'] = 'Port used to connect to Tele Connect';
...
$string['record_force_desc'] = 'Force all Tele Connect meetings to be recorded.  This is a site wide effect and the Tele Connect server must be restarted';
...
$string['conntestintro'] = '<p>A series of tests have been run in order to determine whether the Tele Connect Pro server has been properly setup for this integration to work  and to also determine whether the user credentials provided in the activity global settings has the correct permissions to perform the neccessary tasks required by the  activity module.  If any of the tests below have failed, this activity module will not function properly.</p><p> For further assistance and documentation in how to set up your  Tele Connect Pro server please consult the MoodleDocs help page for this activity module <a href="{$a->url}">Help page</a></p>';
$string['greaterstarttime'] = 'The start time cannot be greater than the end time';
$string['invalidtelemeeturl'] = 'Invalid entry for this field.  Click the help bubble for valid entries';

$string['teleconnect:meetingpresenter'] = 'Meeting Presenter';
$string['teleconnect:meetingparticipant'] = 'Meeting Particpant';
$string['teleconnect:meetinghost'] = 'Meeting Host';
$string['public'] = 'Public';
$string['private'] = 'Private';

// Error codes
$string['emptyxml'] = 'Unable to connect to the Tele Connect Pro server at this time.  Please inform your Moodle administrator.';
$string['adminemptyxml'] = 'Unable to connect to the Tele Connect Pro server at this time.  Click continue to proceed to the activity settings page and test the connection';
...
$string['nopresenterrole'] = 'error: error finding teleconnectpresenter role';
$string['nomeeting'] = 'No meeting exists on the server';
$string['noinstances'] = 'There are no instances of teleconnect';
...
$string['settingblurb'] = '<center><img src="{$a->image}" /></center><br />
    <p>Tele Systems Inc. and Remote-Learner.net have partnered together to create the first publicly available
    and officially sponsored, integration method between Moodle and Tele Acrobat Connect Pro. This new
    integration is designed to simplify the use of synchronous events within Moodle. It provides a
    single-sign-on between the two systems with easy creation and management of Tele Connect Pro
    meetings.</p><br />
    ...
    <p>Visit the <a href="{$a->url}">Tele Connect Moodle Plugins Directory</a> for information on Enterprise support.</p>';
$string['meeturl_help'] = '<p>You can customize the URL that is used to connect to the Tele connect meeting.  The Tele Server domain will always remain the same.
  However the last part of the URL can be customized.
</p>
<p>For example if the Tele Connect server domain was located at <b>http://tele.connect.server/</b>
  when customizing the URL to <b>mymeeting</b>, the URL to connect to the meeting would be <b>http://tele.connect.server/mymeeting</b>.  Leave out the trailing forward slash
</p>
...
$string['pluginadministration'] = 'Tele Connect Administration';
$string['pluginname'] = 'Tele Connect';
$string['modulename'] = 'Tele Connect';
