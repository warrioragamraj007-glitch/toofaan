...
class mod_teleconnect_renderer extends plugin_renderer_base {
    ...
    public function display_meeting_detail ($meetingdetail, $cmid, $groupid = 0) {
        ...
        $target = new moodle_url('/mod/teleconnect/view.php');
        ...
        $html .= html_writer::tag('label', get_string('meetingname', 'teleconnect'), $param);
        ...
        if ($meetingdetail->url) {
            ...
            $html .= html_writer::tag('label', get_string('meeturl', 'teleconnect'), $param);
            $html .= html_writer::end_tag('div');
        ...
        if ($meetingdetail->servermeetinginfo) {
            ...
            $html .= html_writer::tag('label', get_string('meetinfo', 'teleconnect'), $param);
            $html .= html_writer::end_tag('div');
...
//            $html .= html_writer::tag('label', $meetingdetail->url, $param);
            $html .= html_writer::link($meetingdetail->servermeetinginfo, get_string('meetinfotxt', 'teleconnect'), $param);
            $html .= html_writer::end_tag('div');
        ...
        $html .= html_writer::start_tag('div', $param);
        $param = array('for' => 'lblmeetingurl');
        $html .= html_writer::tag('label', get_string('meetingstart', 'teleconnect'), $param);
        $html .= html_writer::end_tag('div');
        ...
        $html .= html_writer::tag('label', get_string('meetingend', 'teleconnect'), $param);
        $html .= html_writer::end_tag('div');
        ...
        $html .= html_writer::tag('label', get_string('meetingintro', 'teleconnect'), $param);
        $html .= html_writer::end_tag('div');
        ...
        $html .= html_writer::tag('label', format_module_intro('teleconnect', $meetingdetail, $cmid), $param);
        $html .= html_writer::end_tag('div');
        ...
        $target = new moodle_url('/mod/teleconnect/join.php', $param);

        $param = array('type'=>'button',
                       'value'=>get_string('joinmeeting','teleconnect'),
                       'name'=>'btnname',
        ...
        $param = array('type'=>'submit',
                       'value'=>get_string('selectparticipants','teleconnect'),
                       'name'=>'participants',
                       );
        $html .= html_writer::empty_tag('input', $param);
        $html .= html_writer::end_tag('div');
    ...
    function display_meeting_recording($recordings, $cmid, $groupid, $sourcescoid) {
        ...
        $html .= html_writer::tag('h3', get_string('recordinghdr', 'teleconnect'), $param);
    ...
    function display_no_groups_message() {
        $html = html_writer::tag('p', get_string('usergrouprequired', 'teleconnect'));
        return $html;
    }
}