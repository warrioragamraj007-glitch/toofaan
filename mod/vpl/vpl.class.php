...
class mod_vpl {
    ...
    public function add_submission($userid, & $files, $comments, & $error) {
        ...
        // Create submission record.
        // $sip=get_complete_user_data(id,$userid)->lastip;
        $sip = $DB->get_field('user', 'lastip', array('id' => $userid));
        //var_dump($sip);
        ...
        $submissiondata->datesubmitted = time();
        $submissiondata->comments = $submittedby . $comments;
        $submissiondata->subip =$sip;//saving ip address of each submission
        // var_dump( $submissiondata);
        $submissiondata->grade = $previousgrade;
    ...
    public function print_footer() {
        ...
        if (! $this->use_seb() ) {
            ...
            // echo 'VPL '. vpl_get_version(); //removed the version display from vpl editor page
            echo '</a>';
            echo '</div>';
        }
        echo $OUTPUT->footer();
