...
function get_currentjailservers($vpl, &$already = []) {
    ...
    //     $record = new stdClass();
    //     $record->servername = $server; // Assuming 'servername' is the column in your 'servers' table
    //     // You can add more columns as needed and populate them here
